...
export default function RoutesPage() {
  ...
  const totalProperties = routes.reduce((acc, r) => acc + r.communities.reduce((a, c) => a + c.properties.length, 0), 0);
    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500">{routes.length} routes · {totalProperties} properties</p>
        </div>
      </div>
